        ...
        <Image src={icon} width={35} height={35} alt="icon" />
          ...
          <div className='flex md:items-start items-center sm:w-4/5 md:justify-between justify-center gap-7 py-5 sm:px-9  px-1 border-b-2 border-blue-500'>
            <div className='flex flex-col justify-between gap-3 md:w-3/5 pt-6'>
              <p className="italic md:text-left text-center">{maintext}</p>
              <ul className='text-center sm:text-left list-disc space-y-3 list-inside pb-4 md:pt-1 pt-5'>
                <li>{point1}</li>
                <li>{point2}</li>
                <li>{point3}</li>
                <li>{point4}</li>
              ...
              <div className='flex flex-col sm:flex-row items-center gap-4'>
                ...
                <Link className='border-yellow-500 border font-bold rounded-2xl py-2 px-5 w-1/2 text-center' href={'#'}>
                View Projects
                </Link>
              </div>
            </div>
