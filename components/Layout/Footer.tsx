        ...
        <div className="w-[350px] flex flex-col items-center gap-6 px-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center text-white py-4">
              <strong className="text-white text-xl pb-2">Our office</strong>
              <span className="text-white text-center">14, rout Kipushi, Lubumbashi RD Congo</span>
              <span className="text-white">+243 808 348 094</span>
              <span className="text-white">8am -9am </span>
            </div>
          </div>
        </div>
        <div className="px-4">
        <div className="text-white flex max-[640px]:flex-col flex-wrap flex-row items-start max-[640px]:items-center xl:gap-28 gap-20 xl:text-center pt-10 sm:w-4/5 md:w-full md:flex-row md:justify-around">
              ...
              >
                ...
                {group.links.map((link, index) => (
                  <Link
                    key={index}
                    href={link.url}
                    className="text-white font-normal text-base leading-normal font-Inria"
                  >
                    {link.name}
                  </Link>
                ))}
