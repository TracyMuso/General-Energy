...
export default function ServicesPage() {
  return (
    <div className="w-full flex flex-col">
      ...
      <ServiceLinks />
      <section id='service-top' className='w-full md:pb-16 pb-8 px-0 h-screen relative pt-[80px]'>
        <div className='service-text w-4/5 lg:m-0 md:mt-8 mt-8 md:ml-8 flex flex-col md:justify-between justify-around service-hero-text md:w-1/2 lg:w-2/5 md:pl-12 xl:pl-20 py-5 rounded-xl h-[370px]'>
          <div className=''>
            <h1 className='xl:text-4xl md:text-3xl text-2xl font-bold pb-3'>Énergie générale</h1>
